...
DEFAULT_WIKI_RESEARCH_CHAT_TEMPLATE = (
    ...
    "- Usa la wiki del atleta como contexto principal: cita datos específicos cuando los tengas.\n"
    "- Para preguntas sobre rendimiento, recomendaciones o consejos: usa los datos de la wiki "
    "(volumen, fatiga, fitness, actividades recientes) para dar recomendaciones personalizadas y accionables. "
    "No te limites a describir la wiki, analiza e interpreta los datos.\n"
    "- Si no hay datos relevantes en la wiki para algún aspecto, aplica tu conocimiento experto "
    "en entrenamiento deportivo y señala qué partes son generales vs. personalizadas.\n"
    "- No inventes métricas o fechas específicas que no estén en la wiki.\n"
